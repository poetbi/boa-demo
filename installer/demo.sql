...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='管理员';

-- 表中的数据 `demo_admin`

INSERT INTO `demo_admin` (`id`, `user`, `pass`, `memo`) VALUES
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='分类';

-- 表中的数据 `demo_category`

INSERT INTO `demo_category` (`id`, `alias`, `title`, `sort`) VALUES
(1, 'yule', '娱乐', 0),
(3, 'keji', '科技', 0),
(4, 'film', '电影', 0),
(5, 'yinyue', '音乐', -1);
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='用户组';

-- 表中的数据 `demo_group`

INSERT INTO `demo_group` (`id`, `name`, `memo`) VALUES
(1, '普通用户', '默认注册用户，不能发文章'),
(2, 'VIP用户', 'VIP组，拥有全部权限');
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='文章';

-- 表中的数据 `demo_news`

INSERT INTO `demo_news` (`id`, `cid`, `status`, `user`, `title`, `content`, `addtime`) VALUES
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='用户';

-- 表中的数据 `demo_user`

INSERT INTO `demo_user` (`id`, `gid`, `user`, `pass`, `sex`, `email`, `regtime`) VALUES
